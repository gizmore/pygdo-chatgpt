        ...
        match self.get_val():
            case 'agi':
                return ('You play the role of a regular user in a chat. Your nickname is Chappy.'
                        ...
                        'You do *not* need to say [Chappy{1}]: in your messages yourself or prefix your messages with the target username.'
                        ...
                        # 'Start commands with $ and do not add any punctuation or similar in your issued bot commands.'
                        ...
                        'It is a good idea to $bj.hold when you got 18 or more points.')
